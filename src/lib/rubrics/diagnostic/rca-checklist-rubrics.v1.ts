import type { GuardsRubric, MappingRubric } from '../rubric-registry.js';

// RCA checklist coverage mapping
// Inputs: coverageRatio (0..1), infraFailed:boolean, netFailed:boolean, pvcFailed:boolean
export const DIAGNOSTIC_RCA_CHECKLIST_MAPPING_V1: MappingRubric = {
...
export const DIAGNOSTIC_RCA_CHECKLIST_SAFETY_V1: GuardsRubric = {
