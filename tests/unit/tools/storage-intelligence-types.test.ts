...
import {
  WEEK1_METRICS,
  type StorageIntelligenceData,
  type PVCBindingFailure,
  type Evidence,
  type ResolutionStep,
  type NamespaceStorageIntelligence,
  type NamespaceStorageAnalytics,
  type StorageMetrics,
  type UtilizationAnalysis,
  type CostProjection
} from '../../../src/tools/storage-intelligence/types';
...
describe('Storage Intelligence Data Models (ADR-012)', () => {
  it('should validate PVCBindingFailure structure and value ranges', () => {
    ...
    const failure: PVCBindingFailure = {
  ...
  it('should validate StorageIntelligenceData minimal compliance', () => {
    const data: StorageIntelligenceData = {
      incidentId: 'inc-123',
      timestamp: Date.now(),
      namespace: 'student03',
  ...
  it('should validate NamespaceStorageAnalytics structures and calculations', () => {
    ...
    const analytics: NamespaceStorageAnalytics = {
      namespace: 'student01',
    ...
    const nsReport: NamespaceStorageIntelligence = {
      incidentId: 'ns-001',
      timestamp: Date.now(),
