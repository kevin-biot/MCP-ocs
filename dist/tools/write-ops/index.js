...
export class WriteOpsTools {
    ...
    memoryManager;
    workflowEngine;
    constructor(openshiftClient, memoryManager, workflowEngine) {
    ...
    async applyConfig(config, namespace, dryRun, sessionId) {
    ...
    async scaleDeployment(deploymentName, replicas, namespace, sessionId) {
    ...
    async restartDeployment(deploymentName, namespace, sessionId) {
