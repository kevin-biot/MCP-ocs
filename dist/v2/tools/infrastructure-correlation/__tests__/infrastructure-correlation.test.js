...
describe('InfrastructureCorrelationChecker', () => {
    ...
    describe('Real-World Scenario: tekton-results-postgres zone conflict', () => {
        ...
        test('should provide actionable recommendations', async () => {
            ...
            expect(recommendations).toContain(expect.stringMatching(/scale up.*eu-west-1a/i));
        });
        ...
        test('should store analysis results for future learning', async () => {
            ...
            expect(mockMemoryManager.storeConversationMemory).toHaveBeenCalledWith('test-memory-storage', expect.stringContaining('Infrastructure correlation analysis'), expect.stringContaining('Infrastructure Analysis Results'), expect.objectContaining({
    ...
    describe('Error Handling', () => {
        test('should handle oc command failures gracefully', async () => {
            ...
            await expect(checker.checkInfrastructureCorrelation({ sessionId: 'test-error' })).rejects.toThrow('Infrastructure correlation failed: oc command failed');
        });
